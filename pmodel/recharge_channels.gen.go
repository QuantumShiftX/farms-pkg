...
type RechargeChannel struct {
	...
	MaxLimitAmount          int64  `gorm:"column:max_limit_amount;type:numeric;not null;comment:单笔最大限额" json:"max_limit_amount"`                 // 单笔最大限额
	...
	FeePercent              int64  `gorm:"column:fee_percent;type:numeric;not null;comment:手续费（百分比）" json:"fee_percent"`                         // 手续费（百分比）
