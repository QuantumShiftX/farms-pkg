...
const (
	...
	FarmLandNotFoundError                                            // 土地不存在
	FarmIrrigationOrFertilizerLandNotFoundError                      // 浇水或者施肥的土地不存
...
var (
	...
	ErrFarmLandNotFound                    = xerr.New(FarmLandNotFoundError, "土地不存在请重试")
	FarmIrrigationOrFertilizerLandNotFound = xerr.New(FarmIrrigationOrFertilizerLandNotFoundError, "浇水或者施肥的土地不存")
)
