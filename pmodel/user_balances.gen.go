...
const TableNameUserBalance = "user_balances"

// UserBalance mapped from table <user_balances>
type UserBalance struct {
	...
	UserID        int64 `gorm:"column:user_id;not null;index:idx_user_balances_user_id,priority:1;comment:用户ID" json:"user_id"` // 用户ID
