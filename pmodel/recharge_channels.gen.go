...
type RechargeChannel struct {
	...
	UserLevels              string  `gorm:"column:user_levels;type:jsonb;comment:会员层级" json:"user_levels"`                              // 会员层级
	PlatformTypes           string  `gorm:"column:platform_types;type:jsonb;comment:充值平台类型" json:"platform_types"`                      // 充值平台类型
	...
	FeeReductionConfig      string  `gorm:"column:fee_reduction_config;type:jsonb;comment:手续费减免配置" json:"fee_reduction_config"`         // 手续费减免配置
	RechargeGiftConfig      string  `gorm:"column:recharge_gift_config;type:jsonb;comment:赠送配置" json:"recharge_gift_config"`            // 赠送配置
	RecommendAmountConfig   string  `gorm:"column:recommend_amount_config;type:jsonb;comment:推荐金额配置" json:"recommend_amount_config"`    // 推荐金额配置
	...
	CustomerRechargeTypes   string  `gorm:"column:customer_recharge_types;type:jsonb;comment:充值类型" json:"customer_recharge_types"`      // 充值类型
