...
type WithdrawPaymentRecord struct {
	...
	OrderNumber        string `gorm:"column:order_number;type:varchar(255);not null;index:idx_withdraw_payment_records_order_number,priority:1;comment:订单号" json:"order_number"`                   // 订单号
	...
	CurrencyCode       string `gorm:"column:currency_code;type:varchar(255);comment:币种" json:"currency_code"`                                                                                      // 币种
